$(document).ready(function() {
  ...
  var xhrTrending = "http://api.giphy.com/v1/gifs/trending?api_key=dc6zaTOxFJmzC&tag=59b72bd8344c42ec8faea4fd13e6318d&limit=49";
  var xhrSearch = "";
  ...
  $('.search_button').click(function() {
    ...
    if ($('input').val() != "") {
      xhrSearch = "http://api.giphy.com/v1/gifs/search?q=" + encodeURI($('input').val()) + "&api_key=dc6zaTOxFJmzC&tag=59b72bd8344c42ec8faea4fd13e6318d&limit=49"
